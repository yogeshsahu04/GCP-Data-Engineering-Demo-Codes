...
bucket='data-proc-demo-src-bkt'
file_name='greenhouse-gas-emissions-industry-and-household-year-ended-2020.csv'
...
df=spark.read.option("header",True).csv('gs://$bucket/$file_name')
